...
# fox_command(command, module_name, filename=os.path.basename(__file__), args="[Arguments]"


@Client.on_message(fox_command("example", module_name="Example", filename=os.path.basename(__file__) args="[Arguments]") & filters.me)
